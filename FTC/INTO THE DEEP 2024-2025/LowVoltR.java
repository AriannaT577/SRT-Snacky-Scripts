...
@Config
@Autonomous(name = "LowVoltR", group = "Autocode")
public class LowVoltR extends LinearOpMode {
    public class Vertical {
        ...
        public class ViperDrive implements Action {
            ...
            public boolean run(@NonNull TelemetryPacket packet) {
                ...
                double pos = ViperV1.getCurrentPosition();
                packet.put("liftPos", pos);
                if (pos > 1200) { // may need to change this for stop space
                    return true;
                } else {
    ...
    public void runOpMode() {
        ...
        Pose2d HAPPENING = new Pose2d(22, 0,0 );
        ...
        TrajectoryActionBuilder tab1 = drive.actionBuilder(BlockPos)
                .splineToConstantHeading(new Vector2d(30, 0), 0) // hang first specimen
                //.turn(Math.toRadians(10))
                .waitSeconds(1)//viper up
        ...
        TrajectoryActionBuilder tab2 = drive.actionBuilder(ZA_HANGO)
                .splineToConstantHeading(new Vector2d(21.3, 0), 0)//align
                .waitSeconds(0.5)
                ;
