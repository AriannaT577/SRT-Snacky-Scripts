...
@Config
@Autonomous(name = "RedBack", group = "Autonomous")
public class TheFuriousFapper extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d postshootPose = new Pose2d (new Vector2d(0, -55), 1.2);//after shooting
        Pose2d firsteatPose = new Pose2d (new Vector2d(48, -33), Math.PI);//after eating first
        Pose2d secondeatPose = new Pose2d (new Vector2d(47, -9), Math.PI);//after eat second
        Pose2d hpeatPose = new Pose2d (new Vector2d(48, -60) , Math.PI);//after eatig hp
        ...
        TrajectoryActionBuilder preloaded = drive.actionBuilder(beginPose)
                ...
                .lineToY(-45)
                .splineToSplineHeading(new Pose2d(0, -50, 1.2), Math.PI / 2)
                ;

        TrajectoryActionBuilder firsteatballs = drive.actionBuilder(postshootPose)
                .setTangent(0)
                .splineToLinearHeading(new Pose2d(17, -33, Math.PI), 0 //y = -34
                        , new TranslationalVelConstraint(200), null)
                .splineToLinearHeading(new Pose2d(48, -33, Math.PI), 0
        ...
        TrajectoryActionBuilder firstpewballs = drive.actionBuilder(firsteatPose)
                ...
                .splineToLinearHeading(new Pose2d(0, -50, 1.2), Math.PI
                        , new TranslationalVelConstraint(200), null)
                ;

        TrajectoryActionBuilder secondeatballs = drive.actionBuilder(postshootPose)
                .setTangent(0)
                .splineToLinearHeading(new Pose2d(16, -9, Math.PI), 0 //y = -10
                        , new TranslationalVelConstraint(200), null)
                .splineToLinearHeading(new Pose2d(48, -9, Math.PI), 0
                        , new TranslationalVelConstraint(100),null )
                ;
        ...
        TrajectoryActionBuilder hpeatballs = drive.actionBuilder(postshootPose)
                ...
                .splineToLinearHeading(new Pose2d(47, -43, Math.PI*5/6), 0
                        , new TranslationalVelConstraint(200), null)
                .setTangent(3*Math.PI/2)
                .splineToLinearHeading(new Pose2d(47, -64, Math.PI*5/6), 3*Math.PI/2
        ...
        TrajectoryActionBuilder hppewballs = drive.actionBuilder(hpeatPose)
                .setTangent(7*Math.PI/6)
                .splineToLinearHeading(new Pose2d(0, -50, 1.2), Math.PI*3/2
                        , new TranslationalVelConstraint(200),null )
                ;
