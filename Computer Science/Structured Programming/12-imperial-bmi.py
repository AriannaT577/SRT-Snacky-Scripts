...
name= input()
print("Hello ",name,"! May I know your weight in pounds?")
pounds=float(input())
print("Thank you! What is your height in feet and inches? First, lets start with feet?")
ft=float(input())
print("And how many inches?")
inches=float(input())

weight= float(pounds*0.454)
height= float((ft*12+inches)/39.37)
